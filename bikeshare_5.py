...
def get_filters(city, month, day):
    ...
    Returns:
        (str) classity - name of the city to analyze
    ...
    while True:
        time = input("\nDo you want to filter as month, day, all or nothing?\n").lower()
        if time == 'month':
            month = input("\nWhich month? January, Feburary, March, April, May, June, all or nothing?\n").lower()
            day = 'all'
            break
